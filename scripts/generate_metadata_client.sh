...
docker run --rm \
    ...
    --additional-properties packageVersion=0.3.3,packageName=gooddata_metadata_client \
...
#
sed -i -e 's/_self/_self_sanitized/g' "${CLIENT_DIR}/gooddata_metadata_client/model_utils.py"
